...
import logoTrackTemplate from "@assets/track-template-logo.webp";
...
export default function Home() {
  ...
  const {
    ...
    videoPreview,
    selectedGenres, selectedMoods, selectedInstruments, selectedVoices,
    vocalGender, energyLevel, era, tempo,
  });
